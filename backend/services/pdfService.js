    ...
    const styledHTML = `
      ...
      <body>
        <div class="header-logo">
          <img src="https://raw.githubusercontent.com/JesseOpitz/new-leaf-city-seeker/logo.png" alt="New Leaf Logo" style="max-height: 80px; display: block; margin: 0 auto 20px;" />
        </div>
        ${htmlContent}
        <div class="footer">
